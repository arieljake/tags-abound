...
module.exports.emailService = require('./lib/server/email');
module.exports.everyauth = require('./lib/server/everyauth');
	...
	this.init = function (serverParts)
	{
		...
		self.router = router.createRouter(
			[
				...
				require('./lib/routes/submissions'),
				require('./lib/routes/lists'),
				require('./lib/routes/profile'),
				require('./lib/routes/listREST'),
				require('./lib/routes/submissionREST'),
				require('./lib/routes/userREST'),
