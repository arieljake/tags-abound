...
ListlyAppRouter.prototype.initRoutes = function ()
{
	// static
	this.app.get('/favicon.ico', listly.utils.routeHandler(this,this.renderStatic));

	// loginRoutes
	this.app.get('/login', listly.utils.routeHandler(this.loginRoutes,this.loginRoutes.login));
	this.app.post('/login', listly.utils.routeHandler(this.loginRoutes,this.loginRoutes.doLogin));
	this.app.get('/register', listly.utils.routeHandler(this.loginRoutes,this.loginRoutes.register));
	this.app.post('/register', listly.utils.routeHandler(this.loginRoutes,this.loginRoutes.doRegister));
	...
	this.app.get('/submissions/new', listly.utils.routeHandler(this.submissionRoutes,this.submissionRoutes.new));
	...
	this.app.get('/submissions/:submissionId/edit', listly.utils.routeHandler(this.submissionRoutes,this.submissionRoutes.edit("submissionId")));
	this.app.post('/submissions', listly.utils.routeHandler(this.submissionRoutes,this.submissionRoutes.postSubmission));
