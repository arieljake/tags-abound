...
var ListlyServer = module.exports.ListlyServer = function (serverParts)
{
	...
	this.router = new listly.ListlyRouter(this.app, [
		new listly.LoginRoutes(this),
		new listly.LoginREST(this),
		new listly.SubmissionRoutes(this),
		new listly.SubmissionREST(this),
		new listly.ListRoutes(this),
		new listly.ListREST(this),
		new listly.UserRoutes(this),
		new listly.UserREST(this),
		new listly.UtilREST(this)
	]);
	// var scheduledTasks = listly.scheduledTasks;
};

ListlyServer.prototype.logObj = function (obj)
{
	var msg = util.inspect(obj);
	this.logMsg(msg);
};

ListlyServer.prototype.logMsg = function (msg)
{
